...
pointLight2.position.set(-1.5, 1, -0.66);
...
/* const pointLightHelper = new THREE.PointLightHelper(pointLight2, 0.75);
scene.add(pointLightHelper); */

// Second Light
const pointLight3 = new THREE.PointLight(0x00ffff, 2);
...
const updateSphere = (event) => {
  sphere.position.y = window.scrollY * 0.0025;
};
